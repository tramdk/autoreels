...
2. CHỈ ĐƯỢC PHÉP sử dụng các font chất lượng cao hỗ trợ Tiếng Việt (có dấu Ư, Ơ, Đ) cực tốt sau — đây là Top 15 font thống trị Google Fonts cho tiếng Việt:
   - Sans-serif: 'montserrat', 'nunito', 'be vietnam pro', 'manrope', 'mulish', 'barlow', 'raleway', 'quicksand', 'inter', 'plus jakarta sans', 'lexend', 'space grotesk', 'archivo', 'oswald', 'bebas neue'.
   - Serif: 'playfair display', 'fraunces', 'cormorant', 'lora', 'merriweather', 'crimson pro', 'dm serif display', 'newsreader'.
   - Display: 'unbounded', 'phudu'.
   - Monospace: 'jetbrains mono', 'space mono', 'source code pro', 'fira code', 'ibm plex mono'.
3. TUYỆT ĐỐI CẤM các font không hỗ trợ tiếng Việt hoặc quá nhàm chán: 'roboto', 'open sans', 'lato', 'poppins', 'outfit', 'anton', 'eb garamond', 'syne', 'georgia', 'times new roman'.
...
5. BẮT BUỘC HỖ TRỢ TIẾNG VIỆT UNICODE (KHÔNG LỖI DIACRITICS):
   ...
   - Ví dụ embed đầy đủ các font top đầu (dùng font nào thì thêm vào link tương ứng):
     <link href="https://fonts.googleapis.com/css2?family=Montserrat:wght@400;600;700;900&family=Nunito:wght@400;600;700;800&family=Be+Vietnam+Pro:wght@400;600;700;800&family=Manrope:wght@400;600;700;800&family=Mulish:wght@400;600;700;800&family=Barlow:wght@400;600;700;800&family=Inter:wght@400;600;700;900&family=Playfair+Display:ital,wght@0,400;0,700;1,400&family=Fraunces:ital,opsz,wght@0,9..144,400;0,9..144,700;0,9..144,900&family=Plus+Jakarta+Sans:wght@400;600;700;800&family=JetBrains+Mono:wght@400;700&display=swap" rel="stylesheet">
   - LƯU Ý: Google Fonts hiện tại tự động detect subset Vietnamese dựa trên request, nhưng nếu font không hiển thị đúng dấu, hãy thêm &subset=vietnamese vào cuối URL.
...
`;
  try {
    ...
    const ALLOWED_FONTS = [
      // Top 15 Vietnamese Google Fonts (article: dafont.vn)
      'montserrat', 'nunito', 'be vietnam pro', 'be-vietnam-pro',
      'manrope', 'mulish', 'barlow', 'raleway', 'quicksand',
      'inter', 'playfair display', 'playfair-display', 'fraunces',
      'cormorant', 'plus jakarta sans', 'plus-jakarta-sans',
      'lexend', 'space grotesk', 'space-grotesk', 'archivo',
      'archivo-black', 'archivo black', 'oswald', 'bebas neue', 'bebas-neue',
      // Serif
      'lora', 'merriweather', 'crimson pro', 'crimson-pro',
      'dm serif display', 'dm-serif-display', 'newsreader',
      // Display
      'unbounded', 'phudu',
      // Monospace
      'jetbrains-mono', 'jetbrains mono', 'space mono', 'space-mono',
...
- "fontFamily": Tên font chữ được chọn (BẮT BUỘC chỉ được chọn một trong các phông chữ hỗ trợ tiếng Việt có dấu tốt nhất sau: "Montserrat", "Nunito", "Be Vietnam Pro", "Manrope", "Mulish", "Barlow", "Inter", "Playfair Display", "Fraunces", "Plus Jakarta Sans", "Lexend", "Lora", "Space Grotesk", "JetBrains Mono"). Tuyệt đối KHÔNG chọn Anton, Georgia, Roboto, Open Sans, Lato, Poppins, Outfit để tránh lỗi hiển thị dấu tiếng Việt.
