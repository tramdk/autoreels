...
export const SocialView: React.FC<SocialViewProps> = ({
  ...
  return (
    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="space-y-8">
       <div>
          <h1 className="text-4xl font-bold tracking-tight text-white mb-2">Social Integrations</h1>
          <p className="text-slate-400">Connect your channels for automated distribution.</p>
        </div>
