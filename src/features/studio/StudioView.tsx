  ...
  return (
    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="space-y-8">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h1 className="text-4xl font-bold tracking-tight text-white mb-2">{t('sidebar.studio')}</h1>
          <p className="text-slate-400">{t('articles.manualDesignTab')}</p>
        </div>
        <div className="flex gap-3">
          <motion.button 
            ...
            className="flex items-center justify-center gap-2 bg-slate-800 text-white px-8 py-4 rounded-2xl font-bold border border-white/10 hover:bg-slate-700 disabled:opacity-50 transition-all"
          >
          ...
          <div className="glass rounded-[32px] p-8 border border-white/5 space-y-6">
             <div>
              ...
              <div className="space-y-4">
                ...
                <button 
                  onClick={addScene}
                  className="w-full py-6 rounded-3xl border-2 border-dashed border-white/5 text-slate-500 hover:text-white hover:border-white/10 hover:bg-white/5 transition-all flex items-center justify-center gap-3 font-bold"
                >
                  <Plus className="w-5 h-5" /> {t('articles.addScene')}
                </button>
              </div>
          </div>
        </div>
