...
import { Clock, FileText, Video as VideoIcon, CheckCircle2 } from 'lucide-react';
...
export const StatusBadge: React.FC<StatusBadgeProps> = ({ status }) => {
  ...
  switch (status) {
    ...
    case 'ready':
      return <span className={`${baseClass} bg-purple-500/10 text-purple-400 border-purple-500/20`}><VideoIcon className="w-3 h-3" /> Video Generated</span>;
    case 'posted':
