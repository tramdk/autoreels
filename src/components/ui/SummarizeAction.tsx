            ...
            >
              <div className="flex items-center justify-between mb-8">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h2 className="text-xl font-black text-white tracking-tight">Chọn ngữ điệu</h2>
                    <p className="text-[10px] text-slate-500 font-bold uppercase tracking-widest">Kịch bản AI sẽ được tối ưu theo phong cách này</p>
                  </div>
                </div>
              ...
              <div className="grid grid-cols-1 gap-3 mb-8">
                {TONES.map(tone => (
                  ...
                  >
                    ...
                    {selectedTone === tone.id && (
                      <div className="w-2 h-2 rounded-full bg-primary shadow-[0_0_10px_#fff]" />
                    )}
                  </button>
                ))}
              </div>
              ...
              <button
                ...
                className="w-full py-4 bg-primary text-white font-black uppercase tracking-[0.2em] text-[11px] rounded-2xl shadow-lg glow-primary hover:opacity-90 transition-all flex items-center justify-center gap-2"
              >
                Tạo kịch bản ngay
